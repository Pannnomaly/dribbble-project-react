    ...
    return (
        <div id="category" className="bg-white px-10 py-15">
            <a href="#" className="flex flex-col justify-center items-center pb-5 hover:text-(--main-dark) transition duration-300 ease-in-out">
                ...
                <div>
                    <p className="text-2xl font-semibold mt-3">Annual Flower</p>
                </div>
            </a>
            <a href="#" className="flex flex-col justify-center items-center pb-5 hover:text-(--main-dark) transition duration-300 ease-in-out">
                <div className="bg-(--main-light) rounded-[50%] w-[200px] h-[200px] p-5 hover:opacity-[0.8] transition duration-300 ease-in-out">
                ...
                <div>
                    <p className="text-2xl font-semibold mt-3">Perennial Flower</p>
                </div>
            </a>
            <a href="#" className="flex flex-col justify-center items-center pb-5 hover:text-(--main-dark) transition duration-300 ease-in-out">
                <div className="bg-(--main-light) rounded-[50%] w-[200px] h-[200px] p-5 hover:opacity-[0.8] transition duration-300 ease-in-out">
                ...
                <div>
                    <p className="text-2xl font-semibold mt-3">Biennial Flower</p>
                </div>
            </a>
            <a href="#" className="flex flex-col justify-center items-center pb-5 hover:text-(--main-dark) transition duration-300 ease-in-out">
                <div className="bg-(--main-light) rounded-[50%] w-[200px] h-[200px] p-5 hover:opacity-[0.8] transition duration-300 ease-in-out">
            ...
            <a href="#" className="flex flex-col justify-center items-center pb-5 hover:text-(--main-dark) transition duration-300 ease-in-out">
                ...
                <div>
                    <p className="text-2xl font-semibold mt-3">Sunflower</p>
                </div>
            </a>
            <a href="#" className="flex flex-col justify-center items-center pb-5 hover:text-(--main-dark) transition duration-300 ease-in-out">
                <div className="bg-(--main-light) rounded-[50%] w-[200px] h-[200px] p-5 hover:opacity-[0.8] transition duration-300 ease-in-out">
                ...
                <div>
                    <p className="text-2xl font-semibold mt-3">Hydrangea</p>
                </div>
            </a>
        </div>
    );
